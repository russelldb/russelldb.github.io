...
1. If Local Version Vector _descends_ Incoming
    1. Increment Vnode's entry in _local_ Version Vector
...
1. If Incoming _descends_ Local
    ...
    1. Write new value to disk
1. If Incoming _concurrent_ with Local
    1. _Merge_ Incoming and Local Version Vectors
...
a small increase in meta data storage fixes the Sibling Explosion bug.
...
This post only covers how Dotted Version Vectors are implemented in
...
[paper](http://arxiv.org/abs/1011.5808), and Ricardo Tomé Gonçalves
